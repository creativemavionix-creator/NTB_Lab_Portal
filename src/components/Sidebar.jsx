      ...
      <aside className={`fixed top-0 bottom-0 left-0 z-50 flex flex-col w-72 bg-[#1e293b] text-slate-200 transition-transform duration-300 transform lg:translate-x-0 ${
        ...
        <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1.5 scrollbar-thin">
          ...
          <button
            ...
            className={`flex items-center justify-between w-full px-4 py-2.5 rounded-md text-xs font-bold transition-all cursor-pointer ${
              isActive('Dashboard') 
              ...
              <div className="pl-3 mt-1 space-y-0.5 border-l border-slate-800 ml-4 text-[11px]">
                {sampleHandlingSubItems.map((item) => (
                  <button
                    ...
                    className={`flex items-center justify-between w-full py-1.5 px-3 rounded transition-colors text-left cursor-pointer ${
          ...
          {selectedRole === 'Admin' && (
            <button
              onClick={() => navTo('Admin')}
              className={`flex items-center justify-between w-full px-4 py-2.5 mt-4 rounded-md text-xs font-bold transition-all border border-dashed cursor-pointer ${
                isActive('Admin')
